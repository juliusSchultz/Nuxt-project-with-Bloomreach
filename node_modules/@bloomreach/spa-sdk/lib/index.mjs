...
let ApiImpl = ApiImpl_1 = class ApiImpl {
    ...
    static getHeaders(options) {
        ...
        return _extends(_extends(_extends(_extends(_extends(_extends(_extends(_extends({}, ip && {
            "X-Forwarded-For": ip
        }), apiVersion && {
    ...
    send(config) {
        ...
        return __awaiter(this, void 0, void 0, (function*() {
            ...
            (_b = this.logger) === null || _b === void 0 ? void 0 : _b.debug("Headers:", _extends(_extends({}, this.headers), config.headers));
            if (config.data) {
